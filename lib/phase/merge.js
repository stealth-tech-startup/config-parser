...
function mergeConfig(parsedDoc, pipelineTemplate) {
    ...
    const mergedPipeline = mergePipelineLevelConfig(parsedDoc, pipelineTemplate);

    console.log('---------mergedPipeline: ', mergedPipeline);
    console.log('---------+++result: ', { ...mergedPipeline, ...newPipeline });

    return { ...mergedPipeline, ...newPipeline };
}
